...
#
#         Input seed household sample filerun
...
popSimDir       <- "C:/MyData/PopulationSim/example_Oakland"
validationDir   <- "C:/MyData/PopulationSim/validation"

scenario        <- "Oakland Test"
region          <- "Oakland County"

geographyList   <- c("REGION", "PUMA", "BLKGRP")
plotGeographies <- c("REGION", "BLKGRP")

geogXWalk       <- read.csv(paste(popSimDir, "data/oak_geo_cross_walk.csv", sep = "/"))
columnMap       <- read.csv(paste(validationDir, "columnMapPopSim_Oakland.csv", sep = "/"))

seed_households <- read.csv(paste(popSimDir, "data/oak_seed_households.csv", sep = "/"))
...
summary2           <- read.csv(paste(popSimDir, "output/summary_BLKGRP_PUMA.csv", sep = "/"))
#summary3           <- read.csv(paste(popSimDir, "output/summary_TRACT.csv", sep = "/"))
summary3           <- read.csv(paste(popSimDir, "output/summary_BLKGRP.csv", sep = "/"))
